                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul>
                            ...
                            <li><a href="#!">Al Ghurair Centre</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mt-n1-9">
                        <div class="pe-lg-1-9">
                            <img src="img/portfolio/portfolio-details-09.jpg" class="mt-1-9" alt="...">
                            <img src="img/portfolio/portfolio-details-10.jpg" class="mt-1-9" alt="...">
                            <img src="img/portfolio/portfolio-details-11.jpg" class="mt-1-9" alt="...">
                            <img src="img/portfolio/portfolio-details-12.jpg" class="mt-1-9" alt="...">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div>
                            ...
                            <h2 class="h1 mb-1-9">Al Ghurair Centre, Dubai</h2>
                            <p>Seamlessly captivating that illuminates your brand and elaborates the perfection of your desires, experience the difference of our passion and professionalism, our glass installation work for various brands in Al Ghurair Centre</p>
