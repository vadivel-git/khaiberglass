                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul>
                            ...
                            <li><a href="#!">Al Majaz Waterfront Park</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mt-n1-9">
                        <div class="pe-lg-1-9">
                            <img src="img/portfolio/portfolio-details-19.jpg" class="mt-1-9" alt="...">
                            <img src="img/portfolio/portfolio-details-20.jpg" class="mt-1-9" alt="...">
                            <img src="img/portfolio/portfolio-details-21.jpg" class="mt-1-9" alt="...">
                            <img src="img/portfolio/portfolio-details-22.jpg" class="mt-1-9" alt="...">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div>
                            ...
                            <h2 class="h1 mb-1-9">Al Majaz Waterfront Park</h2>
                            <div class="mb-4">
                                <h3 class="h5">Client</h3>
                                <p class="mb-0">Eng. Muhammad Kamal</p>
                            </div>
                            <div class="mb-4">
                                <h3 class="h5">Project</h3>
                                <p class="mb-0">Sharjah Hop Boy.</p>
                            </div>
                            <div class="mb-4">
                                <h3 class="h5">Description</h3>
                                <p class="mb-0">10mm Clear Sliding Door & 10mm Clear Yellow Painted Shelves.</p>
                            </div>
                            <div class="mb-4">
                                <h3 class="h5">Location</h3>
                                <p class="mb-0">Al Majaz Waterfront, Sharjah</p>
                            </div>
